...
final class Menu_Icons {
	...
	public static function _init() {
		...
		if ( empty( self::$data['types'] ) ) {
			if ( WP_DEBUG ) {
				trigger_error( esc_html__( 'Menu Icons: No registered icon types found.', 'square-plus' ) );
			}
	...
	public static function _notice_missing_icon_picker() {
		?>
		<div class="error">
			<p><?php esc_html_e( 'Looks like Menu Icons was installed via Composer. Please activate Icon Picker first.', 'square-plus' ); ?></p>
		</div>
		<?php
	}
}
