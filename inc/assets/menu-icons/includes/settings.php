...
final class Menu_Icons_Settings {
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfully updated.', 'square-plus' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfully reset.', 'square-plus' ),
		);
	...
	private static function _add_settings_meta_box() {
		add_meta_box(
			'menu-icons-settings',
			__( 'Menu Icons Settings', 'square-plus' ),
	...
	public static function get_settings_fields( array $values = array() ) {
		$fields = array(
			'hide_label' => array(
				'id'      => 'hide_label',
				'type'    => 'select',
				'label'   => __( 'Hide Label', 'square-plus' ),
				'default' => '',
				'choices' => array(
					array(
						'value' => '',
						'label' => __( 'No', 'square-plus' ),
					),
					array(
						'value' => '1',
						'label' => __( 'Yes', 'square-plus' ),
					),
				),
			),
			'position' => array(
				'id'      => 'position',
				'type'    => 'select',
				'label'   => __( 'Position', 'square-plus' ),
				'default' => 'before',
				'choices' => array(
					array(
						'value' => 'before',
						'label' => __( 'Before', 'square-plus' ),
					),
					array(
						'value' => 'after',
						'label' => __( 'After', 'square-plus' ),
					),
				),
			),
			'vertical_align' => array(
				'id'      => 'vertical_align',
				'type'    => 'select',
				'label'   => __( 'Vertical Align', 'square-plus' ),
				'default' => 'middle',
				'choices' => array(
					array(
						'value' => 'super',
						'label' => __( 'Super', 'square-plus' ),
					),
					array(
						'value' => 'top',
						'label' => __( 'Top', 'square-plus' ),
					),
					array(
						'value' => 'text-top',
						'label' => __( 'Text Top', 'square-plus' ),
					),
					array(
						'value' => 'middle',
						'label' => __( 'Middle', 'square-plus' ),
					),
					array(
						'value' => 'baseline',
						'label' => __( 'Baseline', 'square-plus' ),
					),
					array(
						'value' => 'text-bottom',
						'label' => __( 'Text Bottom', 'square-plus' ),
					),
					array(
						'value' => 'bottom',
						'label' => __( 'Bottom', 'square-plus' ),
					),
					array(
						'value' => 'sub',
						'label' => __( 'Sub', 'square-plus' ),
					),
				),
			),
			'font_size' => array(
				'id'          => 'font_size',
				'type'        => 'number',
				'label'       => __( 'Font Size', 'square-plus' ),
				'default'     => '1.2',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '0.1',
			...
			'svg_width' => array(
				'id'          => 'svg_width',
				'type'        => 'number',
				'label'       => __( 'SVG Width', 'square-plus' ),
				'default'     => '1',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '.5',
			...
			'image_size' => array(
				'id'      => 'image_size',
				'type'    => 'select',
				'label'   => __( 'Image Size', 'square-plus' ),
				'default' => 'thumbnail',
	...
	public static function get_fields() {
		...
		$sections = array(
			'global' => array(
				'id'          => 'global',
				'title'       => __( 'Global', 'square-plus' ),
				'description' => __( 'Global settings', 'square-plus' ),
				'fields'      => array(
					array(
						'id'      => 'icon_types',
						'type'    => 'checkbox',
						'label'   => __( 'Icon Types', 'square-plus' ),
						'choices' => $icon_types,
		...
		if ( ! empty( $menu_id ) ) {
			...
			$sections['menu'] = array(
				'id'          => $menu_key,
				'title'       => __( 'Current Menu', 'square-plus' ),
				'description' => sprintf(
					__( '"%s" menu settings', 'square-plus' ),
				...
				<span class="list-controls">
					<?php
						printf(
							...
							esc_attr__( 'Discard all changes and reset to default state', 'square-plus' ),
							esc_html__( 'Reset', 'square-plus' )
						);
					?>
				</span>
	...
	public static function _enqueue_assets() {
		...
		$js_data = apply_filters(
			...
			array(
				'text'           => array(
					'title'        => __( 'Select Icon', 'square-plus' ),
					'select'       => __( 'Select', 'square-plus' ),
					'remove'       => __( 'Remove', 'square-plus' ),
					'change'       => __( 'Change', 'square-plus' ),
					'all'          => __( 'All', 'square-plus' ),
					'preview'      => __( 'Preview', 'square-plus' ),
					'settingsInfo' => '',
				),
