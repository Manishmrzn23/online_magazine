...
class Online_Magazine_Preloader_Selector_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        if (!empty($this->choices)) {
            ...
            <label>
                ...
                <select class="online-magazine-preloader-selector" <?php $this->link(); ?>>
                    <?php
                ...
                <div class="online-magazine-preloader-container">
                    <?php
                    for ($i = 1; $i <= 16; $i++) {
                        $style = ($this->value() != 'preloader' . $i) ? 'style="display:none"' : '';
                        echo '<div class="online-magazine-preloader online-magazine-preloader' . $i . '"' . $style . '>';
