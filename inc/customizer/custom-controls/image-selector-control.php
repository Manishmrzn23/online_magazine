...
class Online_Magazine_Image_Selector_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        if (!empty($this->choices)) {
            ...
            <label>
                ...
                <select class="online-magazine-image-selector" <?php $this->link(); ?>>
                    <?php
                ...
                <div class="online-magazine-image-container"><img src="<?php echo esc_url($this->image_path . $this->value() . '.png'); ?>"/></div>
            </label>
            <?php
        }
    }
