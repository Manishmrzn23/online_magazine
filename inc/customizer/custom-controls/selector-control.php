...
/** Selector Control */
class Online_Magazine_Selector_Control extends WP_Customize_Control {

    public $type = 'online-magazine-selector';
    ...
    public function render_content() {
        ...
        <label>
            ...
            <div class="online-magazine-selector-labels <?php echo esc_attr($this->class) ?>">
                <?php
