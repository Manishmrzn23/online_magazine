...
class Online_Magazine_Multiple_Selectize_Control extends WP_Customize_Control {

    public $type = 'online-magazine-multiple-selectize';
    public $placeholder;
    public $empty_text;
    ...
    public function render_content() {
        ...
        <label>
            ...
            if (empty($this->choices)) {
                ...
                <select data-placeholder="<?php echo esc_html($this->placeholder); ?>" multiple="multiple" class="online-magazine-selectize" <?php $this->link(); ?>>
                    <?php
