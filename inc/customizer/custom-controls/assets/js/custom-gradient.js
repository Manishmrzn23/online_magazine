jQuery(document).ready(function ($) {
    $('.online-magazine-gradient-box').each(function () {
        var $pickerId = $(this).find('.online-magazine-gradient-picker');
        var $inputId = $(this).find('.online-magazine-gradient-val');
        var $previewId = $(this).find('.online-magazine-gradient-preview');
        var $directionId = $(this).find('.online-magazine-gradient-direction');
        var $customGradId = $(this).find('.online-magazine-gradient-custom')
        ...
        $directionId.on("change", function () {
            ...
            if (direction == 'custom') {
                ...
                orientation = $(this).closest('.online-magazine-gradient-box').find('.ui-slider-handle > span').text();
        ...
        $(this).find('.online-magazine-gradient-range').slider({
            range: "min",
            value: deg,
            min: 0,
            max: 360,
