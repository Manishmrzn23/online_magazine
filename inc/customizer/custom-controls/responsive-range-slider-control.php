...
class Online_Magazine_Responsive_Range_Slider_Control extends WP_Customize_Control {
     ...
     * @var string
     */
    public $type = 'online-magazine-responsive-range-slider';
    public $unit = '';
    ...
    protected function content_template() {
        ...
        <div class="desktop control-wrap active">
            <div class="online-magazine-res-range-slider desktop-slider"></div>
            <div class="online-magazine-res-range-slider-input">
                <input {{{ data.inputAttrs }}} type="number" class="slider-input desktop-input" value="{{ data.desktop.value }}" {{{ data.desktop.link }}} />
            </div>
            <# if ( data.unit ) { #>
            <div class="online-magazine-res-range-slider-unit">{{{ data.unit }}}</div>
            <# } #>
        </div>
        <# } #>
        ...
        <div class="tablet control-wrap">
            <div class="online-magazine-res-range-slider tablet-slider"></div>
            <div class="online-magazine-res-range-slider-input">
        ...
        <div class="mobile control-wrap">
            <div class="online-magazine-res-range-slider mobile-slider"></div>
            <div class="online-magazine-res-range-slider-input">
